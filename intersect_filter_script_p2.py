...
if __name__ == '__main__':
    wao_file = 'Males_equal_to_ref_p2_unfiltered_intersect_WAO.txt'
    vcf_file = 'Males_equal_to_ref_p2_unfiltered.vcf'
    output_file = 'intersect_filter_p2.txt'
